...
export function HomePage({ onBrowseNews, onOpenAuth, posts, onOpenStory, authUser }) {
  return (
    <>
      <HeroSection onBrowseNews={onBrowseNews} onOpenAuth={onOpenAuth} authUser={authUser} />
